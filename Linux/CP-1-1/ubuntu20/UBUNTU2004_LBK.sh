#!/usr/bin/env bash
#
# CIS-LBK CIS Ubuntu Linux 20.04 LTS Benchmark v1.0.0 Build Kit script
# ~/CIS-LBK/UBUNTU2004_LBK.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       11/25/20    Build Kit "CIS Ubuntu Linux 20.04 LTS Benchmark v1.0.0"
#
...
RN="1.1.1.7"
RNA="Ensure mounting of FAT filesystems is limited"
profile="L1S L1W"
REC="vfat_filesystem_disabled"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="ensure_openbsd-inetd_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="ensure_users_dot_netrc_files_not_group_world_accessible"
total_recommendations=$((total_recommendations+1))
runrec
