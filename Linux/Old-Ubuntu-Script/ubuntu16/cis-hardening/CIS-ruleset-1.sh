...
{
    local -A fsvaa
    fsvaa=( [1.1.1.1]=cramfs [1.1.1.2]=freevxfs [1.1.1.3]=jffs2 [1.1.1.4]=hfs [1.1.1.5]=hfsplus [1.1.1.6]=squashfs [1.1.1.7]=udf [1.1.1.8]=vfat)
...
{
    echo
    echo "Ensure AppArmor is not disabled"
    sed -i 's/\bapparmor=0\b//' /etc/default/grub
    update-grub
}
