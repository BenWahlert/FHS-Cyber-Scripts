...
rule-5.2.11()
{
    local maclist="hmac-sha2-512-etm@openssh.com,hmac-sha2-256-etm@openssh.com,umac-128-etm@openssh.com,hmac-sha2-512,hmac-sha2-256,umac-128@openssh.com"
    echo
...
rule-5.6()
{
    ...
    local wheel_memb=`read_usr_param wheel_member`
